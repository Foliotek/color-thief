 ...
 * @license
 */
function getImagePixelArray(a,b){var c=new CanvasImage(a);try{for(var d,e,f,g,h,i=c.getImageData(),j=i.data,k=c.getPixelCount(),l=[],m=0;m<k;m+=b)d=4*m,e=j[d+0],f=j[d+1],g=j[d+2],h=j[d+3],h>=125&&(e>250&&f>250&&g>250||l.push([e,f,g]));return c.removeCanvas(),l}catch(a){throw c.removeCanvas(),"Color Thief - The canvas has been tainted by cross-origin data"}}var CanvasImage=function(a){this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),document.body.appendChild(this.canvas),this.width=this.canvas.width=a.width,this.height=this.canvas.height=a.height,this.context.drawImage(a,0,0,this.width,this.height)};CanvasImage.prototype.clear=function(){this.context.clearRect(0,0,this.width,this.height)},CanvasImage.prototype.update=function(a){this.context.putImageData(a,0,0)},CanvasImage.prototype.getPixelCount=function(){return this.width*this.height},CanvasImage.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)},CanvasImage.prototype.removeCanvas=function(){this.canvas.parentNode.removeChild(this.canvas)};var ColorThief=function(){};/*!
